...
![An example of a STRING, world, stored under a key, hello](./Images/An%20example%20of%20a%20STRING,%20world,%20stored%20under%20a%20key,%20hello.svg "An example of a STRING, world, stored under a key, hello")
...
![An example of a LIST with three items under the key, list-key. Note that item can be in the list more than once](./Images/An%20example%20of%20a%20LIST%20with%20three%20items%20under%20the%20key,%20list-key.%20Note%20that%20item%20can%20be%20in%20the%20list%20more%20than%20once.svg "An example of a LIST with three items under the key, list-key. Note that item can be in the list more than once")
...
![An example of a SET with three items under the key, set-key](./Images/An%20example%20of%20a%20SET%20with%20three%20items%20under%20the%20key,%20set-key.svg "An example of a SET with three items under the key, set-key")
...
![An example of a ZSET with two members:scores under the key zset-key](./Images/An%20example%20of%20a%20ZSET%20with%20two%20members:scores%20under%20the%20key%20zset-key.svg "An example of a ZSET with two members:scores under the key zset-key")
...
![The concept of Sorted Sets](./Images/The%20concept%20of%20Sorted%20Sets.png "The concept of Sorted Sets")
...
![An example of a HASH with two keys:values under the key hash-key](./Images/An%20example%20of%20a%20HASH%20with%20two%20keys:values%20under%20the%20key%20hash-key.svg "An example of a HASH with two keys:values under the key hash-key")
...
![A Bitmap with one Set on offsets 0, 3, and 4 and zero Set on offsets 1 and 2](./Images/A%20Bitmap%20with%20one%20Set%20on%20offsets%200,%203,%20and%204%20and%20zero%20Set%20on%20offsets%201%20and%202.png "A Bitmap with one Set on offsets 0, 3, and 4 and zero Set on offsets 1 and 2")
...
![Representation of Bitmap](./Images/Representation%20of%20Bitmap.png "Representation of Bitmap")
